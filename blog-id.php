...
<div class="page position-relative">
    <main>
        <div class="container max-w744">
            ...
            <div class="d-flex justify-content-between flex-column flex-sm-row gap-3 gap-sm-0 align-items-center align-items-sm-start">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="javascript:void(0)"><img src="/assets/images/instagram.svg" alt="Instagram Logo"></a>
                    <a href="javascript:void(0)"><img src="/assets/images/linkedin.svg" alt="Linkedin Logo"></a>
                </div>
            </div>
        </div>
