...
<div class="container metrics-container align-content-center text-white position-relative mt-4">
    <div id="metricsCarousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="metric-item d-flex align-items-center justify-content-center">
                    ...
                    <div class="metric-box ms-3">
                        ...
                        <div class="metric-label text-uppercase text-lgrey font-raleway fs-18 fw-bold">ONBOARDING</div>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="metric-item d-flex align-items-center justify-content-center">
                    ...
                    <div class="metric-box ms-3">
                        ...
                        <div class="metric-label text-uppercase text-lgrey font-raleway fs-18 fw-bold">Kuruluş</div>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="metric-item d-flex align-items-center justify-content-center">
                    ...
                    <div class="metric-box ms-3">
                        ...
                        <div class="metric-label text-uppercase text-lgrey font-raleway fs-18 fw-bold">Kullanıcı</div>
                    </div>
                </div>
            </div>
        </div>
        <button class="carousel-control-prev" type="button" data-bs-target="#metricsCarousel"
                data-bs-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#metricsCarousel"
                data-bs-slide="next">
...
<div class="page position-relative home-page">
    <main>
        ...
        <div class="container mt-150">
            <div class="row align-items-center position-relative text-img flex-column flex-lg-row text-center text-lg-start">
                <div class="col-lg-6 text-content d-flex flex-column justify-content-center text-center text-lg-start mb-4 mb-lg-0">
                    <h2 class="mb-3 letterSpace-45">BEKLEMEYE S<span class="text-blue">ON</span></h2>
                    <p class="text-lgrey font-raleway fs-18 max-w457">
                        Tüm banka izinlerini tek ekranda yönetin. Başvuru süreçlerini hızlandırın ve tüm süreçleri
                        anlık olarak takip edin. Böylece, her adımda tam kontrol sahibi olarak operasyonel
        ...
        <div class="container mt-150">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <h2 class="letterSpace-45 fs-42">SİZ SADECE <span class="text-blue">İŞİ</span> DÜŞÜNÜN</h2>
                </div>
            </div>
        ...
        <div class="container mt-150 max-w1140">
            <h2 class="letterSpace-45 text-center mb-5"><span class="text-blue">VALLET </span> GÜVENCESİYLE </h2>
